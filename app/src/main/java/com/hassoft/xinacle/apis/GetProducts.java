    ...
    public String getData(Context context,String CompanyBranchID) {
        if(GlobalFunctions.isInternetAvailable(context)) {
            try {
                ...
                String getUrl = context.getResources().getString(R.string.apilinkprefix) + "Configuration/GetProducts?CompanyBranchID=" + CompanyBranchID;//https://www.pakistanscrabble.org/api.php";
