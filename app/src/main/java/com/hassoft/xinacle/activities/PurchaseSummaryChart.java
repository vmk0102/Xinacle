...
public class PurchaseSummaryChart extends AppCompatActivity {
    LineChart mChart;
    PurchaseMaster[] pa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.purchasesummarychart);
        mChart=(LineChart) findViewById(R.id.purchasesummmarychart);
